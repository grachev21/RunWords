const LabelInfoDot = ({ title, value }) => {
  return (
    <main className="flex flex-row relative text-color_four bg-color_three rounded-lg p-3 m-2 h-16 border border-color_four/10 w-full sm:w-full">
      ...
      <section className="">
        <h1 className="text-sm font-semibold b-1">{title}</h1>
